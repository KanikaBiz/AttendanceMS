...
@section('breadcrumb_title', trans('Manage Student'))
@section('breadcrumb_pagename', trans('Student List'))
@section('breadcrumb', trans('Student List'))

<div class="card">
    <div class="card-header">
        <h3 class="card-title">{{ trans('Student List') }}</h3>
        <div class="card-tools">
            <a href="{{ route('admin.students.create') }}" class="btn btn-primary">{{ trans('Add Student') }}</a>
        </div>
    </div>
    <div class="card-body">
                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-sm btn-danger delete-teacher" data-id="{{ $user->id }}" data-url="{{ route('admin.students.destroy', $user->id) }}">
