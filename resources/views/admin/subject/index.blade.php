...
@section('content')
@section('breadcrumb_title', trans('Manage Subjects'))
@section('breadcrumb_pagename', trans('Subject List'))

@section('breadcrumb', trans('Manage Subject'))
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="crudObjectModalLabel">{{ trans('global.add') }} {{ trans('global.new') }}
                    {{ trans('Manage Subject') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="crudObjectForm" action="{{ route('admin.' . $crudRoutePath . '.store') }}" method="POST">
                     {{ csrf_field() }}
...
$(document).ready(function() {
    ...
    $('#addNewObject').on('click', function() {
        ...
        $('#crudObjectForm').attr('action', '{{ route("admin.subjects.store") }}');
    ...
    $(document).on('click', '.objectEdit', function(e) {
        ...
        let id = $(this).data('id');
        $.ajax({
            url: '{{ route("admin.subjects.index") }}/' + id + '/edit',
            type: 'GET',
